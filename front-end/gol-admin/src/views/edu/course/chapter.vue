<template>
  <div class="app-container">
    <div v-if="this.$route.params && this.$route.params.id">
    ...
    <ul class="chanpterList">
      <li v-for="cv in chapterVideoList" :key="cv.id">
        <p>
          {{ cv.title }}
          <span class="acts">
            <el-button style type="text" @click="openVideo(cv.id)">添加课时</el-button>
            <el-button style type="text" @click="openEditChatper(cv.id)">编辑</el-button>
            <el-button type="text" @click="removeChapter(cv.id)">删除</el-button>
          </span>
        </p>

        <!-- 视频 -->
        <ul class="chanpterList videoList">
          <li v-for="video in cv.children" :key="video.id">
            <p>
              {{ video.title }}
    ...
    <!-- 添加和修改章节表单 -->
    <el-dialog :visible.sync="dialogChapterFormVisible" :title="chpaterTitle">
       <!-- <el-dialog  :visible.sync="dialogChapterFormVisible" title="修改章节"> -->
...
export default {
  ...
  methods: {
    ...
    saveOrUpdate() {
      if (!this.chapter.id) {
        // this.chpaterTitle="添加章节"
        this.addChapter();
      } else {
        this.chpaterTitle="修改章节"
        this.updateChapter();
      }
    },
